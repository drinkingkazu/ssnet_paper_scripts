...
# Generate temp file 
#
import tempfile, ures_template, filler_template
...
proto_cfg.write(ures_template.get_template().replace('CONFIG_NAME',filler_cfg.name))
proto_cfg.flush()
...
if '1e1p' in FLAVOUR:
    fout.write(',eminus_energy,eminus_mom,eminus_dirx,eminus_diry,eminus_dirz,proton_energy,proton_mom,proton_dirx,proton_diry,proton_dirz')
